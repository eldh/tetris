...
function renderPart(param, i, param$1) {
  return ReasonReact.element(/* Some */[String(i)], /* None */0, Pixel.make(/* tuple */[
                  param[0] + param$1[0] | 0,
                  param[1] + param$1[1] | 0
                ], "rgb(200, 200, 0)", /* array */[]));
}
  ...
  return /* record */[
          ...
          /* render */(function () {
              var comps = List.mapi((function (param, param$1) {
                      return renderPart(pos, param, param$1);
              ...
              return ReasonReact.element(/* None */0, /* None */0, View$BsReactNative.make(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[Style$BsReactNative.style(/* :: */[
                                    ...
                                    ])], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(/* array */[$$Array.of_list(comps)]));
            }),
