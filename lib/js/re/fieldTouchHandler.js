...
function make(moveX, rotate, moveY, children) {
  return /* record */[
          ...
          /* render */(function (self) {
              return ReasonReact.element(/* None */0, /* None */0, View$BsReactNative.make(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[/* record */[
                                  /* onMoveShouldSetResponder : Some */[(function () {
                                        console.log("onMoveShouldSetResponder");
                                        return true;
                                      })],
                                  /* onMoveShouldSetResponderCapture : Some */[(function () {
                                        return true;
                                      })],
                                  /* onResponderGrant : Some */[(function (e) {
                                        return Curry._1(self[/* send */3], /* Start */Block.__(1, [coord(e)]));
                                      })],
                                  /* onResponderMove : Some */[(function (e) {
                                        return Curry._1(self[/* send */3], /* Move */Block.__(0, [coord(e)]));
                                      })],
                                  /* onResponderReject : Some */[(function () {
                                        console.log("reject");
                                        return /* () */0;
                                      })],
                                  /* onResponderRelease : Some */[(function (e) {
                                        return Curry._1(self[/* send */3], /* End */Block.__(2, [coord(e)]));
                                      })],
                                  /* onResponderTerminate : Some */[(function () {
                                        console.log("terminate");
                                        return /* () */0;
                                      })],
                                  /* onResponderTerminationRequest : Some */[(function () {
                                        console.log("terminationrequest");
                                        return /* () */0;
                                      })],
                                  /* onStartShouldSetResponder : Some */[(function () {
                                        return true;
                                      })],
                                  /* onStartShouldSetResponderCapture : Some */[(function () {
                                        return true;
                                      })]
                                ]], /* None */0, /* None */0, /* Some */[Style$BsReactNative.style(/* :: */[
                                    ...
                                    ])], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(children));
            }),
          /* initialState */(function () {
              return /* record */[
                      /* start : None */0,
                      /* lastMoveCoord : None */0,
                      /* pos : None */0
                    ];
            }),
          ...
          /* reducer */(function (action, state) {
              switch (action.tag | 0) {
                case 0 : 
                    ...
                    var match$3 = match$2 ? match$2[0] : start;
                    var yLastMove = match$3[1];
                    var xLastMove = match$3[0];
                    var updateCoord = function () {
                      return /* Update */Block.__(0, [/* record */[
                                  /* start */state[/* start */0],
                                  /* lastMoveCoord : Some */[thisCoord],
                                  /* pos */state[/* pos */2]
                                ]]);
                    };
                    if (dir) {
                      var match$4 = yLastMove - yNow > pieceWidth && state[/* lastMoveCoord */1] === /* None */0;
                      if (match$4) {
                        Curry._1(rotate, /* () */0);
                      ...
                      var match$6 = xLastMove - xNow > pieceWidth;
                      if (match$6) {
