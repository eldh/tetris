  ...
  return /* record */[
          ...
          /* render */(function (param) {
              ...
              return ReasonReact.element(/* None */0, /* None */0, Curry.app(SafeAreaView$BsReactNative.make, [
                              ...
                              /* None */0,
                              /* array */[
                                match[/* gameOver */0] ? ReasonReact.element(/* None */0, /* None */0, View$BsReactNative.make(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* Some */[Style$BsReactNative.style(/* :: */[
                                                    Style$BsReactNative.position(/* Relative */1),
                                                    /* :: */[
                                                      Style$BsReactNative.display(/* Flex */0),
                                                      /* :: */[
                                            ...
                                            ReasonReact.element(/* Some */["piece" + (String(activePiece[/* x */2]) + String(activePiece[/* y */1]))], /* None */0, Piece.make(activePiece[/* piece */0], activePiece[/* rotation */3], /* tuple */[
                                                      activePiece[/* x */2],
                                                      activePiece[/* y */1]
                                                    ], /* array */[])),
                                            $$Array.of_list(List.flatten(List.mapi((function (i, row) {
                                                            return List.map((function (pixel) {
                                                                          return ReasonReact.element(/* Some */["pixel" + (String(pixel[/* x */0]) + String(i))], /* None */0, Pixel.make(/* tuple */[
                                                                                          pixel[/* x */0],
                                                                                          i
                                                                                        ], "rgb(90,90,90)", /* array */[]));
                                                                        }), row);
                                ...
                                ReasonReact.element(/* None */0, /* None */0, Score.make(match[/* score */4], /* array */[])),
                                ReasonReact.element(/* None */0, /* None */0, Level.make(match[/* level */5], /* array */[]))
                              ]
                            ]));
            }),
